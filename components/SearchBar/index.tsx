    ...
    <form onSubmit={onSubmit}>
      <div className="flex items-center w-full rounded-full relative">
        <div className="flex items-center relative">
          <IoSearchOutline className="absolute ml-4 w-5 h-5 text-accent" />
        </div>
        <input
          className="w-full py-4 pl-12 pr-4 rounded-full bg-background border border-accent text-accent"
